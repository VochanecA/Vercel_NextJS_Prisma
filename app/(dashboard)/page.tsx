            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <a
                  ...
                  target="_blank"
                >
                  <Button className="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-black dark:text-white border border-gray-200 dark:border-gray-700 rounded-full text-lg px-8 py-4 inline-flex items-center justify-center">
                    {t('deployButton')}
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            ...
            <div className="mt-8 lg:mt-0 flex justify-center lg:justify-end">
              <a
                ...
                target="_blank"
              >
                <Button className="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-black dark:text-white border border-gray-200 dark:border-gray-700 rounded-full text-xl px-12 py-6 inline-flex items-center justify-center">
